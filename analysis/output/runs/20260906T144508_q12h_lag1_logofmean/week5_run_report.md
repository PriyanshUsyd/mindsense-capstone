...
| State | Evidence | Occasions | % of all | Permitted |
|---|---|---|---|---|
| A | `evidence_available` | 105 | 0.3% | templated message only; no numbers |
| A | `no_claim` | 375 | 1.06% | templated message only; no numbers |
| B | `evidence_available` | 3,450 | 9.76% | descriptive only; no comparison, no relationship claim |
| B | `no_claim` | 7,859 | 22.23% | descriptive only; no comparison, no relationship claim |
| C | `evidence_available` | 8,454 | 23.92% | comparison permitted; hedged relationship claim permitted |
| C | `no_claim` | 15,105 | 42.73% | comparison permitted; relationship claim forbidden |


**64.1% of State C occasions are `no_claim`** — "comparison is permitted but no relationship may be stated" is the single most common situation the chatbot is in, not an edge case. Per-occasion detail: `state_evidence_combinations.csv` (two-value) and `state_evidence_combinations_4tier.csv` (four-tier).
