...
## 4. Cold-start state snapshot (sections 4-5), as of each participant's last day
- State A: 5
- State B: 141
- State C: 74
...
- This snapshot evaluates cold-start state once per participant (their last sensing day) to demonstrate the logic end-to-end; a rolling per-report-date evaluation is Week 6 scope per the Build Plan ('write into actual working logic').
